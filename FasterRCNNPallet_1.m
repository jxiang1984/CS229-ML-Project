...
DataForNextNetwork = 1;         % A logical parameter to prepare data and extract ROIs from the given image to train the CNN classifier.
...
if PalletDatasetWithRotation
    ...
    % Load RGB Image information table without considering the artifical data.
...
if doTrainingAndEval
    ...
    %'NegativeOverlapRange', [0 0.3]...); %'BoxPyramidScale', 1.2); 'NegativeOverlapRange', [0 0.3], ...
else
